...
```{r load data}
#Load data and harmonize variable names
...
<strong>Sofia Charlot, MPH</strong>
</p>
...
<div style="border: 1px solid #ccc; padding: 12px; border-radius: 6px; margin-bottom: 15px; text-align: left;">
  <p style="font-size: 16px;">
    <strong>Local food systems</strong> are interconnected components that support the production, distribution, and consumption of food. <strong>Local food systems shape food access</strong> through mechanism like availability, accessibility, and affordability. <strong>Use the next two tabs to explore the local food system components included in this study.</strong>
  </p>
</div>

<div style="display:flex; flex-wrap:wrap; gap:15px; margin-bottom:15px;">

<div style="flex:1 1 400px; border:1px solid #ccc; padding:12px; border-radius:6px; text-align:left;">
    
<h3><strong>Commercial Food System Components</strong></h3>

<img src="images/commercial.jpeg" width=100%>

<p>
<strong>Commercial components are physical structures that facilitate formal buying and selling of food.</strong> They include the wholesale or individual sale of fresh, frozen, processed, or prepared food to consumers via convenience stores, grocery stores, supermarkets, dollar stores, specialty stores, pharmacies, fruit and vegetable markets, and vending machines.
<br>
<br>
Commercial components reflect a regulated retail environment – often characterized as “brick and mortar” – even as online retail expands. <strong>Such standardization signals the relatively static character of commercial components as features of the built food environment.</strong>
<br>
<br>
They are <strong>designed to operate within parameters set by federal and local government and within industries that favor uniformity.</strong>
</p>
...
<h3><strong>Communal Food System Components</strong></h3>

<img src="images/communal.png" width=100%>

<p><strong>Communal components encompass the ways in which people exchange food outside of strictly retail contexts, with designs tailored to community preferences and needs.</strong> They include gardens, farms, orchards, farmers’ markets, food-buying cooperatives, community-supported agriculture programs (CSAs), farm-to-school initiatives, and food banks.
<br>
<br>
Beyond material exchange, <strong>communal food spaces emphasize connection, knowledge transfer, and interdependence</strong> among people, between people and the environment, and across organizational initiatives.
<br>
<br>
These dynamics can exist in commercial settings, but  are often more pronounced in communal spaces by intention: <strong>community members and institutions design these spaces for social connection and local responsiveness.</strong>
</p>
</div>
...
#Interactive Visual #1 Commercial Components

pal <- colorFactor(
  palette = c("#8DA0CB", "#009E73", "#F0E442",  "#D55E00", "#CC79A7", "#0072B2", "#E69F00", "#56B4E9",  "#76B7B2", "#4D4D4D"),
...
m <- leaflet(options = leafletOptions(
    ...
    addTiles(
    "https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png?key=cb1_2zgw_1_3ca3d2245ba413735c70510e",
...
#Interactive Visual #2 Communal Components
...
#Interactive Visual #3 Food Insecurity Prevalence
...
choro_map <- leaflet(
  ...
  options = leafletOptions(
    ...
    addTiles(
    "https://{s}.basemaps.cartocdn.com/light_nolabels/{z}/{x}/{y}.png?key=cb1_2zgw_1_3ca3d2245ba413735c70510e",
    attribution = '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>, &copy; <a href="https://carto.com/attributions">CARTO</a>') |>
  fitBounds(
...
<div style="border: 1px solid #ccc; padding: 12px; border-radius: 6px; margin-bottom: 15px; text-align: left;">
  <ul style="font-size: 16px;">
    ...
    <li>The average number of communal components was 3 per 10,000 residents, and the average number of commercial components was 18 per 10,000 residents.</li>
    <li>Commercial retailers are more concentrated in the metro area than communal components, and the amount of these components vary widely across neighborhoods.
  </li>
  </ul>
</div>
